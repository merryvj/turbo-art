...
<div class="flex flex-col">
    ...
    <div class="container mt-3">
        ...
        <div class="flex flex-col border-white/10 border-t pt-2.5 justify-between w-full text-xs gap-1">
            <div class="flex justify-center">Custom</div>
            <ColorInput bind:color title="" />
        </div>
